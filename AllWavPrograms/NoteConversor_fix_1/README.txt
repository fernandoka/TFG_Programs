...
Esta versión realiza la interpolación realizando aritmética de punto fijo mal implementada. La operación de multiplicación (fixMul), 
produce desbordamiento en consecuencia de no tipar correctamente los operandos. Este problema esta resuelto en la version fix_2.
 
Los archivos .wav generados con esta aplicación son los que mejor suenan con diferencia, aunque se sigue escuchando mucho ruido molesto, pero la nota es audible,
aunque parece generar la nota a la doble ferecuencia bajo mi percepción.
