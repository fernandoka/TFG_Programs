...
Esta versión realiza la interpolación realizando aritmética de punto fijo (Q2.22). Las operaciones de punto fijo se suponen que estan bien implementadas.
Los archivos .wav generados con esta aplicación son prácticamente idénticos ( por no decir iguales ) a los generados por la versión con aritmética de doble precisión.
